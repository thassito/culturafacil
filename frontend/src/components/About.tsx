  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
        <div className="bg-gray-800/20 backdrop-blur-xl p-8 rounded-2xl shadow-lg border border-gray-700/50 text-center">
          <h3 className="text-3xl font-bold text-white mb-6">Para quem faz a cultura acontecer.</h3>
