  ...
  if (error) {
    return (
      <div className="flex justify-center items-center min-h-screen bg-gray-100 dark:bg-gray-900 text-red-500">
        Erro ao carregar oportunidades: Failed to edit, 0 occurrences found for old_string (import OpportunityCard from '../components/OpportunityCard'; // We will create this component next
    ...
    <div className="flex flex-col md:flex-row min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-white font-sans">
      ...
      <div className="w-full md:w-2/3 h-64 md:h-screen bg-gray-200 dark:bg-gray-800 flex items-center justify-center relative">
        <div className="text-center">
          ...
          <p className="text-500 dark:text-gray-600">(Visualização do mapa aparecerá aqui)</p>
        </div>
      ...
      <div className="w-1/3 bg-white dark:bg-gray-900 p-6 overflow-y-auto">
        ...
        <div className="space-y-4">
          {opportunities.length > 0 ? (
            ...
            <p className="text-gray-500 dark:text-gray-400">Nenhuma oportunidade encontrada.</p>
          )}
        </div>
      </div>
    </div>
