    ...
    <div className="flex flex-col md:flex-row min-h-screen bg-gray-900 text-white font-sans">
      ...
      <div className="w-full md:w-2/3 h-64 md:h-screen bg-gray-800 flex items-center justify-center relative">
        <div className="text-center">
          <h2 className="text-4xl font-bold text-gray-500">Mapa</h2>
      ...
      {/* Events List Area */}
      <div className="w-full md:w-1/3 bg-gray-900 p-6 overflow-y-auto">
        <h1 className="text-3xl font-bold mb-4">Eventos no Ceará</h1>
